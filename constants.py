...
CMD_STATUS_NVMESH_CLIENT = "/etc/init.d/nvmeshclient status"
CMD_STOP_NVMESH_CLIENT = "/etc/init.d/nvmeshclient stop"
CMD_START_NVMESH_CLIENT = "/etc/init.d/nvmeshclient start"
CMD_STATUS_NVMESH_MANAGER = "/etc/init.d/nvmeshmgr status"
CMD_STOP_NVMESH_MANAGER = "/etc/init.d/nvmeshmgr stop"
CMD_START_NVMESH_MANAGER = "/etc/init.d/nvmeshmgr start"
CMD_RESTART_NVMESH_MANAGER = "/etc/init.d/nvmeshmgr restart"
CMD_RESTART_NVMESH_CLIENT = "/etc/init.d/nvmeshclient restart"
...
CMD_RESTART_NVMESH_MCM = "/opt/NVMesh/client-repo/management_cm/managementCM.py start"